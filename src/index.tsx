    ...
    <React.StrictMode>
        <div className="todo">
            ...
            <div className="todo__tasks">
                <div className="tasks">
                    <a href="/lists/1">
                        <h2 className="tasks__title" style={{color: 'rgb(100, 196, 237)'}}>
                            Продажи
                            <EditIcon/>
                        </h2>
                    </a>
                    <div className="tasks__items">
                        <div className="tasks__items-row">
                            <div className="checkbox"><input id="task-1" type="checkbox"/><label
                                htmlFor="task-1">
                        ...
                        <div className="tasks__items-row">
                            <div className="checkbox"><input id="task-2" type="checkbox"/><label htmlFor="task-2">
                                <svg width="11" height="8" viewBox="0 0 11 8" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.29999 1.20001L3.79999 6.70001L1.29999 4.20001" stroke="#000"
                                          strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
